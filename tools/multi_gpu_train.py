...
def train():
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        lr = warmup_lr(cfgs.LR, global_step, cfgs.WARM_SETP, num_gpu) #LR= 5e-4  warm_step=(1.0 / 4.0 * SAVE_WEIGHTS_INTE)
            ...
            for step in range(cfgs.MAX_ITERATION // num_gpu):
                ...
                if step % cfgs.SHOW_TRAIN_INFO_INTE != 0 and step % cfgs.SMRY_ITER != 0:
                    ...
                    if step % cfgs.SHOW_TRAIN_INFO_INTE == 0 and step % cfgs.SMRY_ITER != 0:
                        ...
                        if step % cfgs.loss_save == 0:
                            results.append(total_loss_dict_['total_losses'])  # by wu
                ...
                if step > 0 and (step+1) % ((cfgs.MAX_ITERATION/5) // num_gpu) == 0:

...
def parse_args():
    ...
    parser.add_argument('--data_dir', dest='data_dir',
                        help='data path',
                        default='../data/DATA/test/images/', type=str)
    parser.add_argument('--save_dir', dest='save_dir',
                        help='demo imgs to save',
                        default='../data/DATA/test/', type=str)
...
if __name__ == '__main__':
    ...
    inference('../data/DATA/test/images/', #args.data_dir
              inference_save_path='../data/DATA/test/infer_test_resuls')#args.save_dir



#python inference.py --data_dir ../data/DATA/test/images/ --save_dir ../data/DATA/test/

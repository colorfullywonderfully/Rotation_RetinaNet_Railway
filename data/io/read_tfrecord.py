...
def next_batch(dataset_name, batch_size, shortside_len, is_training):
    ...
    if is_training:
        ...
        pattern = os.path.join('/home/yunpengwu/RetinaNet_Tensorflow_Rotation-master/data/io/DOTA/train/tfrecord/RAIL_train.tfrecord') #railway_track_train.tfrecord
    else:
        pattern = os.path.join('/home/yunpengwu/RetinaNet_Tensorflow_Rotation-master/data/io/DOTA/train/tfrecord/RAIL_test.tfrecord') #../data/tfrecord

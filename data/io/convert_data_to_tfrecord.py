...
tf.app.flags.DEFINE_string('VOC_dir', './DOTA/train/trainval/', 'Voc dir')
tf.app.flags.DEFINE_string('xml_dir', 'labelTxt_test', 'xml dir')
tf.app.flags.DEFINE_string('image_dir', 'images_test', 'image dir')
tf.app.flags.DEFINE_string('save_name', 'test', 'save name')
tf.app.flags.DEFINE_string('save_dir', './DOTA/train/tfrecord/', 'save name')
tf.app.flags.DEFINE_string('img_format', '.jpg', 'format of image')
tf.app.flags.DEFINE_string('dataset', 'RAIL', 'dataset')
            ...
            for child_item in child_of_root:
                ...
                if child_item.tag == 'bndbox':
                    ...
                    for node in child_item:
                        tmp_box.append(float(node.text))  #int

...
STANDARD_COLORS = [
    'AliceBlue', 'Chartreuse', 'Aqua','Aquamarine', 'Azure', 'Tomato', 'Bisque', 'BlanchedAlmond', 'BlueViolet',
    'BurlyWood', 'BlueViolet', 'GreenYellow', 'orange', 'AntiqueWhite',
    'Chocolate', 'CornflowerBlue', 'Cornsilk', 'Crimson', 'Cyan',
    'DarkCyan', 'DarkGoldenRod', 'DarkGrey', 'DarkKhaki', 'BlanchedAlmond',
    'DarkOrchid', 'DarkSalmon', 'DarkSeaGreen', 'DarkTurquoise',
    'DeepPink', 'DeepSkyBlue', 'DodgerBlue', 'FireBrick', 'FloralWhite',
    'ForestGreen', 'Fuchsia', 'Gainsboro', 'GhostWhite', 'CadetBlue', 'GoldenRod',
    'Salmon', 'Tan', 'HoneyDew', 'HotPink', 'IndianRed', 'Ivory', 'Khaki',
    'Lavender', 'LavenderBlush', 'LawnGreen', 'LemonChiffon', 'LightBlue',
    'LightCoral', 'LightCyan', 'BurlyWood', 'LightGray', 'LightGrey',
    'LightGreen', 'LightPink', 'Aquamarine', 'LightSeaGreen', 'LightSkyBlue',
...
def draw_boxes_with_label_and_scores(img_array, boxes, labels, scores, method, in_graph=True):
    ...
    for box, a_label, a_score in zip(boxes, labels, scores):
        ...
        if a_label != NOT_DRAW_BOXES: #0
            num_of_objs += 1
            draw_a_rectangel_in_img(draw_obj, box, color=STANDARD_COLORS[a_label], width=7, method=method)
            #print (STANDARD_COLORS[a_label])###########
...
def draw_boxes(img_array, boxes, labels, scores, color, method, in_graph=True):
    ...
    for box, a_label, a_score in zip(boxes, labels, scores):
        ...
        if a_label != NOT_DRAW_BOXES:
            num_of_objs += 1
            draw_a_rectangel_in_img(draw_obj, box, color=color, width=4, method=method)
